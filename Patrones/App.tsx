...
export default function App() {
  ...
  const [productos, setProductos] = useState<Producto[]>(
    productoServices.obtenerProductos()
  );

  const agregarProducto = () => {

    const nuevosProductos = productoServices.agregarProducto(nombreProducto, precioProducto);
  ...
  const eliminarProducto = (id: number) => {
    const nuevosProductos = productoServices.eliminarProducto(id);
    setProductos(nuevosProductos);
  };
